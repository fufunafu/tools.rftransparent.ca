...
| Personal warehouse report | Active warehouse employee, or management with an employee profile | Shared-station name selector; a selected identity must be an active warehouse employee |
