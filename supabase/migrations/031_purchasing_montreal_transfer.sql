-- Rename the Montreal status code from 'montreal_restock' to
-- 'montreal_transfer'. Montreal is one of our own warehouses, so
-- pulling stock from it is a transfer, not a restock/reorder.
--
-- Identical to migration 030 except for one string in the case
-- expression. Safe to re-run.
