...
export default function SidebarLayout({ children }: { children: React.ReactNode }) {
  ...
  // They never close one: a destination outside every section leaves whatever
  // is open alone, so the only thing that closes a section is the user
  // clicking its header. This is adjusted during render rather than in an
  // effect, so the rail is never painted with the wrong section open.
