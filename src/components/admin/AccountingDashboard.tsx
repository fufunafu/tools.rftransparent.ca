...
const RevenueCostTrendChart = dynamic(
  () => import("./AccountingCharts").then((m) => ({ default: m.RevenueCostTrendChart })),
  { ssr: false, loading: () => <div className="h-[220px] animate-pulse" /> }
);
const MarginTrendChart = dynamic(
  () => import("./AccountingCharts").then((m) => ({ default: m.MarginTrendChart })),
  { ssr: false, loading: () => <div className="h-[160px] animate-pulse" /> }
);
const TopProductsChart = dynamic(
  () => import("./AccountingCharts").then((m) => ({ default: m.TopProductsChart })),
    ...
    <div className="space-y-6">
      ...
      {data.trend.length > 0 && (
        <div className="bg-white rounded-xl border border-sand-200 overflow-hidden">
          ...
          <div className="px-5 py-4">
            <RevenueCostTrendChart trend={data.trend} days={days} />
          </div>
        </div>
      )}
      ...
      {data.trend.length > 0 && (
        <div className="bg-white rounded-xl border border-sand-200 overflow-hidden">
          ...
          <div className="px-5 py-4">
            <MarginTrendChart trend={data.trend} days={days} />
          </div>
        </div>
      )}
    </div>
    ...
    <div className="space-y-6">
      ...
      {chartData.length > 0 && (
        <div className="bg-white rounded-xl border border-sand-200 overflow-hidden">
          ...
          <div className="px-5 py-4">
            <TopProductsChart chartData={chartData} chartMetric={chartMetric} currency={currency} />
          </div>
        </div>
      )}
