...
// route's initial bundle (same pattern as SalesMap/SalesMapView).
const ShopifyCharts = dynamic(() => import("./ShopifyCharts"), {
  ssr: false,
  loading: () => (
              ...
              <div className="bg-white rounded-xl border border-sand-200 overflow-hidden">
                ...
                <div className="px-5 py-4">
                  ...
                  {activeStore.chartState === "loaded" && activeStore.chart.length > 0 && (
                    <ShopifyCharts chart={activeStore.chart} chartRange={activeStore.chartRange} />
                  )}
                  {activeStore.chartState === "loaded" && activeStore.chart.length === 0 && (
