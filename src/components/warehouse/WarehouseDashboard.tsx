...
const WarehouseCharts = dynamic(() => import("./WarehouseCharts"), {
  ssr: false,
  loading: () => (
    <div className="h-[280px] flex items-center justify-center text-sand-400 text-sm animate-pulse">Loading chart...</div>
  ),
});
        ...
        <div className="space-y-6">
          ...
          {chartData.length > 0 && (
            <div className="bg-white rounded-xl border border-sand-200/60 p-4">
              ...
              <WarehouseCharts chartData={chartData} />
            </div>
          )}
